...
\title{\Huge User Manual\\Version 2.20}
...
\textit{\colorbox{red}{WARNING}}: If full simulation box size was used to pack the molecules, the chance of having overlap due to applying periodic boundary condition is high. If total energy of simulation become greater that $1.0 e^{14}$, \texttt{System Total Energy Calculation} will be performed at \texttt{EqSteps} to preserve energy value.\\
